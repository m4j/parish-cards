...
class PersonSubForm(Form):
    ...
    ru_last_name = StringField('Фамилия', validators=[Optional()])
    ru_maiden_name = StringField('Добрачная фамилия', validators=[Optional()])
    ru_first_name = StringField('Имя', validators=[Optional()])
    ru_other_name = StringField('Иное имя', validators=[Optional()])
    ru_patronymic_name = StringField('Отчество', validators=[Optional()])
